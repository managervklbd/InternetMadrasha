...
export const metadata: Metadata = {
    title: 'Homework Report | Admin Dashboard',
    description: 'View student homework submissions and grades',
};
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold font-bengali text-zinc-900 dark:text-zinc-50">হোমওয়ার্ক রিপোর্ট</h1>
                    <p className="text-sm text-zinc-500 font-bengali">শিক্ষার্থীদের জমা দেওয়া হোমওয়ার্ক এবং মূল্যায়নের তালিকা</p>
                </div>
            </div>
                                        ...
                                        <TableCell>
                                            <div className="flex flex-col gap-0.5">
                                                ...
                                                <div className="flex items-center gap-1.5 text-xs text-zinc-500">
                                                    <span>শিক্ষক:</span>
                                                    <span className="font-bengali">{sub.teacherName}</span>
                                                </div>
                                            </div>
                                        </TableCell>
                                        <TableCell>
